 ...
 * @author T
 */
public class HorasTrabajadasVentanas extends javax.swing.JFrame {

    /**
     * Creates new form HorasTrabajadasVentanas
     */
    public HorasTrabajadasVentanas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        saludar.setBackground(new java.awt.Color(0, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HorasTrabajadasVentanas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HorasTrabajadasVentanas().setVisible(true);
            }
        });
    }
